...
<head>
  ...
  <title>{{ trans('front.koshk') }} -- {{ trans('admin.login') }}</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="#"> {{ trans('front.koshk') }}</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">{{ trans('admin.login_start') }}</p>
...
<!-- AdminLTE App -->
<script src="{{ admin_ui('dist/js/adminlte.min.js') }}"></script>
</body>
</html>
